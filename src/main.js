  ...
  createWidgetContent() {
    this.widgetContainer.innerHTML = `
        <header class="widget__header">
            <h3>اكتب رأيك</h3>
            <p>رأيك يهمنا و يساعدنا لمعرفه شعورك</p>
        </header>

        <form>
            <div class="form__field">
                <label for="review_title">اكتب عنوان رأيك</label>
                <input
                type="text"
                id="review_title"
                name="review_title"
            ...
            <div class="form__field">
                <label for="review_message">اكتب  رأيك</label>
                <textarea
                id="review_message"
                name="review_message"
                required="required"
...
function initializeWidgetReviews() {
  ...
  new ProductRatingWidget("above-description", 4);  // Example for Product Rating Widget 1
}
